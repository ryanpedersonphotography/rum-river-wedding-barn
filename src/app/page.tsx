...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id="home" className="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-subtitle">Minnesota&apos;s Premier Venue</div>
            <h1>Rum River<br />Barn</h1>
            <p className="lead-text">
              Where rustic charm meets<br />modern elegance
            </p>
      ...
      {/* Section 2: Alternating Content Blocks with Wave Down */}
      <section className="alternating-blocks divider-wave-down">
        <div className="container">
      ...
      {/* Section 3: Services with Wave Up */}
      <section className="services-reveal divider-wave-up">
        <div className="container">
      ...
      {/* Section 4: Venue Spaces with Angle Down */}
      <section className="venue-showcase divider-angle-down">
      ...
      {/* Section 5: Packages with Angle Up */}
      <section className="packages-section divider-angle-up">
        <div className="container">
      ...
      {/* Section 6: Team/Family - Curve Down */}
      <section className="team-section divider-curve-down">
        <div className="container">
      ...
      {/* Section 7: Blog - Curve Up */}
      <section className="blog-section divider-curve-up">
        <div className="container">
      ...
      {/* Section 8: Instagram Gallery - Split Down */}
      <section className="instagram-section divider-split-down">
        <div className="container">
